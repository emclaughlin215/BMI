function [decodedPosX, decodedPosY, newParameters] = positionEstimatorULTIMATE(trial, Param)
    %Parameters    
    N_iterations = 5;
    speed_std = 0.02 ;
    speed_std2 = 0.3 ;
    ...
    %             
            ...
            newParameters.Speed_estimate_prev = correctingSpeed2(Param_iter, Speed_estimate_prev, trial);
